...
export const feedbackSchema = z.object({
  totalScore: z.number().describe("Overall score for the interview from 0 to 100."),
  strengths: z.array(z.string()).min(1).describe("List of strengths shown by the candidate. Must contain at least one strength."),
  areasForImprovement: z.array(z.string()).min(1).describe("List of areas where the candidate can improve. Must contain at least one area."),
  ...
  }).describe("A breakdown of scores for each specific category from 0 to 10."),
});
